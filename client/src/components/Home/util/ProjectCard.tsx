...
const ProjectCard = () => {
  ...
  const par =
    projects.length > 0
      ? parseInt(((projects[0].raised / projects[0].aid) * 100).toString())
      : 20;
  console.log(par);
          ...
          <div key={project._id}>
            ...
            >
              ...
              <div className="containerCardProject">
                אנחנו מזמינים אתכם לקחת חלק ולתמוך בכרם בוטיק אשר ניזון מחומרים
                אורגנים וללא ריסוסים. אנו מייצרים יין טבעי כפי שאבותינו עשו
                לפנינו.
                <div
                  style={{
              ...
              <div style={{ paddingBottom: "16px", paddingTop: "16px" }}>
                <div>
                  ...
                  <div style={{ margin: "0px calc(48% - 25px)" }}>
                    <span>48%</span>
                  </div>
                  <div
                    role="progressbar"

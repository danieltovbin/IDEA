...
const Supporters = () => {
  ...
  const sumOfGifts = (userId: string) => {
    ...
    const userDonate = allDonations.filter(
      (donate: Donation) => donate.userToken == userId
    ).length;
    return userDonate;
  };
            ...
            >
              <div style={{ display: "flex", justifyContent: "flex-start" }}>
                {donation.anonymous ? (
                  ...
                  >
                    <path d="M12,24C5.4,24,0,18.6,0,12S5.4,0,12,0s12,5.4,12,12S18.6,24,12,24z M12,1C5.9,1,1,5.9,1,12 s4.9,11,11,11s11-4.9,11-11S18.1,1,12,1z"></path>
                    <path d="M18.3,18.8c-0.3,0-0.5-0.2-0.5-0.5c0-3.2-2.6-5.7-5.7-5.7s-5.7,2.6-5.7,5.7 c0,0.3-0.2,0.5-0.5,0.5s-0.5-0.2-0.5-0.5c0-3.8,3-6.8,6.8-6.8s6.8,3,6.8,6.8C18.8,18.6,18.6,18.8,18.3,18.8z"></path>
                    <path d="M12,10.4c-2,0-3.7-1.6-3.7-3.7S10,3.1,12,3.1s3.7,1.6,3.7,3.7S14,10.4,12,10.4z M12,4.2 c-1.5,0-2.6,1.1-2.6,2.6s1.1,2.6,2.6,2.6s2.6-1.1,2.6-2.6S13.5,4.2,12,4.2z"></path>
                  </svg>
                ) : (
                  <img
                    style={{
                    ...
                    src="https://headstart.co.il/static/anonymousUserAvatars/headstart/anonymous5Support.webp"
                    alt=""
                  />
                )}
              ...
              <div style={{ display: "flex", paddingLeft: "30%" }}>
                ...
                >
                  ...
                  <div style={{ marginRight: "5px" }}>
                    ...
                    <p style={{ fontSize: "11px", fontWeight: "bold" }}>
                      {donation.date ? donation.date.split("T", 1): ""}
                    </p>
                  </div>
                </div>
                <div

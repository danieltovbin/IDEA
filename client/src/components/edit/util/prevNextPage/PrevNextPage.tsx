...
const PrevNextPage:FC<PrevNextPageProps> = ({prevPageName,nextPageName,showContinuation,showContinuationIcon}) => {
  ...
  return (
    ...
    <div style={{ display: "flex", maxWidth: "580px" }}>
      ...
      <Typography onClick={() => navigate(`/${nextPageName}`)} style={{ whiteSpace: "nowrap", color: "#388602", cursor: "pointer", fontSize: "13px", fontWeight: "bold" }}>שמירה {showContinuation && <span>והמשך</span>}</Typography>

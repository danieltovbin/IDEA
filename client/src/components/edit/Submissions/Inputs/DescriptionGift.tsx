...
const DescriptionGift = () => {
  return (
    <div style={{marginTop: "40px"}}>
        ...
        <ValidationTextFields inputId={"descriptionGift"} placeholder={"עד 2500 תווים"} customCondition={(value)=>value.length > 0 && value.length < 2500} customConditionLogic={(value) => value.length > 2500} textError="הטקסט שהוכנס חורג ממגבלת התוים לשדה זה" />
    </div>
  )
}

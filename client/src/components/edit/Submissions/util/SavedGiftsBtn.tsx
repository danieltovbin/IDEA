...
import './scss/SavedGiftsBtn.scss';
import { FC } from 'react';

interface SavedGiftsBtnProps {
    onDelete: ()=> void;
    onEdit: ()=> void;
}

const SavedGiftsBtn:FC<SavedGiftsBtnProps> = ({onDelete,onEdit}) => {
    return (
        <div className='SavedGiftsBtn'>
            <Button onClick={onDelete} variant="outlined" color="secondary">
                <svg focusable="false" viewBox="0 0 24 24" aria-hidden="true" style={{ width: '20px', height: '20px', fill: 'rgb(56, 134, 2)' }}>
            ...
            <Button variant="outlined" color="primary">
                <svg focusable="false" viewBox="0 0 24 24" aria-hidden="true" style={{ width: '20px', height: '20px', fill: 'rgb(56, 134, 2)' }}>
                    <path d="M16.17,18.41H5.74a.5.50,0,0,1-.5-.5V8.17a.47.47,0,0,1,.15-.35L9.56,3.65a.47.47,0,0,1,.35-.15h6.26a.5.50,0,0,1,.5.5V17.91A.5.50,0,0,1,16.17,18.41Zm-9.93-1h9.43V4.5H10.12L6.24,8.38Z"></path>
                    <path d="M9.91,8.67H5.74a.5.50,0,0,1-.5-.5.5.50,0,0,1,.5-.5H9.41V4a.5.50,0,0,1,.5-.5.5.50,0,0,1,.5.5V8.17A.5.50,0,0,1,9.91,8.67Z"></path>
                    <path d="M18.26,20.5H7.83a.5.50,0,0,1-.5-.5V17.91a.5.50,0,0,1,.5-.5.51.51,0,0,1,.5.5V19.5h9.43V6.59H16.17a.51.51,0,0,1-.5-.5.5.50,0,0,1,.5-.5h2.09a.5.50,0,0,1,.5.5V20A.5.50,0,0,1,18.26,20.5Z"></path>
                </svg>
                שכפול
            </Button>
            <Button onClick={onEdit} variant="outlined" color="primary">
                <svg focusable="false" viewBox="0 0 24 24" aria-hidden="true" style={{ width: '20px', height: '20px', fill: 'rgb(56, 134, 2)' }}>
                    ...
                    <path d="M8.87,19.11A.47.47,0,0,1,8.52,19a.48.48,0,0,1,0-.7L19.24,7.53a.89.89,0,0,0,0-1.26L17.73,4.76a.91.91,0,0,0-1.26,0Z"></path>
                    <path d="M8.87,19.11A.47.47,0,0,1,8.52,19L5,15.48a.48.48,0,0,1,0-.7.5.5,0,0,1,.71,0l3.47,3.48a.48.48,0,0,1,0,.7A.47.47,0,0,1,8.87,19.11Z"></path>

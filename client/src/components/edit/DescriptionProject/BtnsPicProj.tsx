...
const BtnsPicProj= () => {
    ...
    return (
        <div>
            <button style={{ position: "absolute", right: "12px", bottom: "60px", padding: 0 }} tabIndex={0} type="button">
                <span >
            ...
            <button style={{ position: "absolute", right: "12px", bottom: "15px", padding: 0 }} tabIndex={0} type="button">
                <span >
                    <svg focusable="false" viewBox="0 0 24 24" aria-hidden="true" style={{ width: '24px', height: '24px', fill: 'rgb(56, 134, 2)' }}>

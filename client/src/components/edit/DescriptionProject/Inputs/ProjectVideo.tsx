...
const ProjectVideo:FC<InputProps> = ({addChangeToProject, value})=> {
    ...
    return (
        <div>
            ...
            <ValidationTextFields name="videoLink" value={value} addChangeToProject={addChangeToProject} inputId={"projectVideo"} placeholder={"קישור לסרטון שלך ל youtube או vimeo"} customCondition={isValidVideoUrl} customConditionLogic={(value)=> !isValidVideoUrl(value)} textError="לינק לסרטון אינו תקין"/>
        </div>
    )
}

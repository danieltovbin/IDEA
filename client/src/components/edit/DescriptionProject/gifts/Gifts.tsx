...
const Gifts = () => {
  ...
  return (
    <div className="gifts">
      <p>
        על מנת לשלוח את הפרויקט לאישור יש להכניס תשורה אחת לפחות. ניתן להוסיף
        ולהוריד תשורות לאורך חיי הפרויקט. התשורות זוהי בעצם הדרך למשוך את קהל
        התומכים, חשבו רחב ומגוון ככל הניתן
      </p>
      <Container className="newGift">
        <Container>
          <Container>
            <SvgIcon
      ...
      <div className="addGiftForm">
        <h3>הוספת תשורה לפרויקט:</h3>
        <label htmlFor="giftName">שם התשורה (עד 60 תווים)</label>
        <input id="giftName" type="text" max={60} placeholder="שם התשורה" />

        <label htmlFor="giftCost">עלות התשורה</label>
        ...
        >
          ...
          {moreOptions ? <IoIosArrowDown /> : <IoIosArrowUp />}
        </div>
        {moreOptions ? (
          <div>
